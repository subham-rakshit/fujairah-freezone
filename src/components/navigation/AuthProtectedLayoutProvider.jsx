  ...
  const handleResize = useCallback(() => {
    ...
    if (width < 768) {
      ...
      if (layoutType === layout.HORIZONTAL) {
        ...
        setBodyLeftMargin(toggleButtonStatus ? "ml-[290px]" : "ml-[70px]");
        setLeftSidebarWidth(toggleButtonStatus ? "w-[290px]" : "w-[70px]");
      } else {
        setBodyLeftMargin(toggleButtonStatus ? "ml-[250px]" : "ml-0");
      ...
      if (layoutType === layout.HORIZONTAL) {
        ...
        setBodyLeftMargin(toggleButtonStatus ? "ml-[70px]" : "ml-[290px]");
        setLeftSidebarWidth(toggleButtonStatus ? "w-[70px]" : "w-[290px]");
      } else {
        if (leftSidebarSizeMain === sidebarMainSize.LG) {
          setBodyLeftMargin(toggleButtonStatus ? "ml-0" : "ml-[250px]");
          ...
          setBodyLeftMargin(toggleButtonStatus ? "ml-0" : "ml-[180px]");
          ...
          setBodyLeftMargin(toggleButtonStatus ? "ml-[250px]" : "ml-[65px]");
          setLeftSidebarWidth(toggleButtonStatus ? "w-[250px]" : "w-[65px]");
