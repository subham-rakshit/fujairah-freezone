...
const NewsDetailsSection = ({
  ...
  // Transform the date outside of JSX for better performance
  const transformedDate = hasNewsArticleData
    ? useTransformDate(newsArticleData.createdAt)
    : null;
  ...
  return (
    <div className="w-full px-[8px] md:px-[60px] mb-[80px] flex flex-col gap-[20px] lg:gap-[40px]">
