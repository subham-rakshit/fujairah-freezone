...
const PublicFooterLogoAndSocialLinks = ({ filesList, settingsData }) => {
  // Get Settings Data
            ...
            <ul className="flex items-center gap-[8px]">
              {socialsKeys.map((social, index) => (
                <Link
                  ...
                  key={`${social}-${index + 1}`}
                >
                  <li className="size-[40px] rounded-[10px] border border-[#fff] px-[16px] py-[8px] flex items-center justify-center">
