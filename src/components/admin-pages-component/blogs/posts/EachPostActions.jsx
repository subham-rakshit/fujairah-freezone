      ...
      >
        ...
        {useUIPermissionCheck(
          ...
          <DropdownMenuItem className="flex items-center justify-between gap-2 text-[12px]">
            <span>Edit</span>
            <Link
              href={`${editRoute}/${postDetails._id}`}
        ...
        {useUIPermissionCheck(
          ...
          <DropdownMenuItem className="flex items-center justify-between gap-2 text-[12px]">
            ...
            <DeleteButton
              userId={userId}
              targetDetails={postDetails}
              targetType={targetType}
              targetName={postDetails.title}
        ...
        {useUIPermissionCheck(
          ...
          <DropdownMenuItem className="flex items-center justify-between gap-2 text-[12px]">
            <span>Active</span>
            <SwitchButton
              args={[userId, postDetails._id]}
              status={postDetails.isActive}
