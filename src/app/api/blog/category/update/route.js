  ...
  try {
    ...
    if (!isTranslationData) {
      ...
      const updateResponse = await updateTranslation(
        ...
        "en",
        {
          ...
          shortDescription: updatedCategory?.description || "",
        }
      );
      ...
      return successResponse({
        message: `${updatedCategory?.name || "Anonymous"}category updated successfully.`,
        status: 200,
      });
    }
    ...
    const updateResponse = await updateTranslation(
      ...
      translateData.lang,
      {
        ...
        shortDescription: translateData.description,
      }
    );
    if (!updateResponse.success) {
      return errorResponse({
